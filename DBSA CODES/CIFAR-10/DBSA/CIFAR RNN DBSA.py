...
# Define the RNN model (unchanged)
class RNN(nn.Module):
...
def enhanced_dynamic_batch_size_adjuster(B_t, L_t, G_t, avg_loss, avg_gradient, alpha=20.0, beta=0.5, kappa=60, min_batch=16, max_batch=2048):
